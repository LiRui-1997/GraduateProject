...
var Element = /*#__PURE__*/function () {
  function Element(_item) {
    ...
    this.changeValueToVars = function (k, value, skipPlugin) {
      var isArray = (Array.isArray(value) || k.match(/color|fill|stroke/i) || k.match(_utils.shadowExp) && typeof value === 'string' || typeof value === 'string' && value.split(/[\s|,]/).length > 1) && !(k in _.Plugins);
      ...
      for (var i = 0; i < root.targets.length; i++) {
        ...
        for (var key in _this.vars) {
          ...
          if (cItem.plugins) {
            ...
            var targetValue = (_ref = root.attr ? target.getAttribute(key) : vars[key] || target[key]) !== null && _ref !== void 0 ? _ref : (0, _utils.getDefaultStart)(key);
            var startData = (_startAt$key = startAt[key]) !== null && _startAt$key !== void 0 ? _startAt$key : targetValue; // root.vars[i][key] ??

            var isStartAt = (0, _typeof2.default)(startData) === 'object' && 'vars' in startData && 'count' in startData;
            ...
            s[key] = isStartAt ? (0, _utils.getStartAtValue)(targetValue, startData) : parseFloat(startData);
          }
        }
    ...
    this.props = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _utils.initAnimProps), _props);
