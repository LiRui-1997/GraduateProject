...
if(0===i){var f=255*u
return new z(G,f,f,f,e,o)}for(var c=u<.5?u*(1+i):u+i-u*i,s=2*u-c,p=0,l=0,h=0,g=0;g<3;g++){var v=a+1/3*-(g-1)
v<0&&v++,1<v&&v--
var f=void 0
f=6*v<1?s+6*(c-s)*v:2*v<1?c:3*v<2?s+(c-s)*(2/3-v)*6:s,f*=255,0===g?p=f:1===g?l=f:h=f}return new z(G,p,l,h,e,o)},S),L={r:255,g:255,b:255,h:360,s:1,l:1,a:1}
...
n=A}var c=g(r[1]),s=i||o?g(r[2]):v(r[2]),p=i||o?g(r[3]):v(r[3]),l=f?g(r[4]):1
return new z(n,c,s,p,l,f)}(t)||Z(255,0,0)}function Z(t,r,n){return new z(G,t,r,n,1,!1)}function R(t,r,n){var e=r.f,o=r.r,a=r.g,i=r.b,u=r.a,f=void 0===n?r.o:n
...
return R(_.f,new l(G,255-t.r,255-t.g,255-t.b,_.a,_.o))},l.prototype.lighten=function(t,r){var _=this,n=R(A,_),e=L.l,o=n.b+(r?e-n.b:e)*v(t)
return R(_.f,new l(A,n.r,n.g,o,_.a,_.o))},l.prototype.darken=function(t,r){var _=this,n=R(A,_),e=n.b-(r?n.b:L.l)*v(t)
return R(_.f,new l(A,n.r,n.g,e,_.a,_.o))},l.prototype.saturate=function(t,r){var _=this,n=R(A,_),e=L.s,o=n.g+(r?e-n.g:e)*v(t)
return R(_.f,new l(A,n.r,o,n.b,_.a,_.o))},l.prototype.desaturate=function(t,r){var _=this,n=R(A,_),e=L.s,o=n.g-(r?n.g:e)*v(t)
return R(_.f,new l(A,n.r,o,n.b,_.a,_.o))},l.prototype.grayscale=function(){return this.desaturate(1)},l.prototype.fade=function(t){var _=this,r=E("a",v(t))
return R(_.f,new l(_.f,_.r,_.g,_.b,r,!0))},l.prototype.fadeOut=function(t,r){var _=this,n=E("a",_.a-(r?_.a:1)*v(t))
return R(_.f,new l(_.f,_.r,_.g,_.b,n,!0))},l.prototype.fadeIn=function(t,r){var _=this,n=E("a",_.a+(r?_.a:1)*v(t))
...
return r==r?t+"px":t}}(t.width))},t.borderColor=k,t.borderStyle=H,t.borderWidth=X,t.color=M,t.hsl=function(t,r,n){return new z(A,I(t),v(r),v(n),1,!1)},t.hsla=function(t,r,n,e){return new z(A,I(t),v(r),v(n),v(e),!0)},t.rgb=Z,t.rgba=function(t,r,n,e){return new z(G,t,r,n,v(e),!0)},t.ColorHelper=z,t.linearGradient=function(t){for(var r=[],n=1;n<arguments.length;n++)r[n-1]=arguments[n]
