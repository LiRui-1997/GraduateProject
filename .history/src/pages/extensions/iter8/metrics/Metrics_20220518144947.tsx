...
var metrics_url =
  'https://metric.ingress.isa.buaanlsde.cn/d/eXPEaNnZz/experiment-metrics?orgId=1&refresh=10s&from=now-15m&to=now&var-service=reviews&var-baseline=reviews-v2&var-candidate=reviews-v4&var-candidate=reviews-v3&var-namespace=bookinfo-iter8&var-window_size=30s&kiosk=tv';
